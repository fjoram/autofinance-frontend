...
function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Step 2: Create profile in appropriate table based on user type
            if (userType === 'buyer') {
            ...
            <div className="auth-card">
                ...
                <form onSubmit={handleSubmit}>
                    <div className="form-group">
                        <label>
                            {userType === 'buyer' ? 'Full Name' : 'Business Name'}
                        </label>
                        <input
                            type="text"
                            name="fullName"
                            ...
                            required
                            placeholder={userType === 'buyer' ? 'Enter your name' : 'Enter business name'}
                        />
                    </div>
